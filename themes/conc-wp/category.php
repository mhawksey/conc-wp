...
?>
	<div id="content">
     ...
     <?php if ( !is_user_logged_in() ) { 
			...
			<p>The Reader is searching and displaying content related to the conference. If you have a blog <?php echo $blog_reminder; ?> and include the text #altc2013 in the title or post content for it to appear in the Reader (<a href="http://altc2013.alt.ac.uk/help/reader-help-and-information/">Help</a>). <?php echo $log_reminder; ?></p>
