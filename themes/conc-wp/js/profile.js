...
jQuery(document).ready(function($) {
	var instructions = "If you would like us to include your blog posts in the 'Conference Reader' enter your blog address and <a id='searchForRSS' href='javascript:void(0)'>click here</a> and select the correct 'Blog RSS' from below. Any blog posts that you publish with altc2013 in the post title or body will automatically be included in the Reader.";
