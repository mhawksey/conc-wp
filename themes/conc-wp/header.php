...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?> id="bp-default">
		...
		<div id="header">
            <div role="navigation" id="header_links">
            <?php //wp_nav_menu( array( 'container' => false, 'menu_id' => 'header-nav', 'theme_location' => 'header-nav', 'fallback_cb' => 'bp_dtheme_main_nav' ) ); ?>
            <a href="#" id="un-button" style="background-color: rgb(150, 46, 116);"><i class="icon-bell"></i>Feedback</a>
            </div>
